...
const generateTagDevAliasPages = require('./generateTagDevAliasPages');
...
async function runSSG() {
  try {
    ...
    await generateTagDevAliasPages(partials, allTags, allDevelopers, baseurl, dirs); // Then, generate tag/dev pages
